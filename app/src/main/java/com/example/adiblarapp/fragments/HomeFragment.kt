...
import com.example.adiblarapp.adapter.PagerAdapter
...
import com.example.adiblarapp.viewmodel.HomeViewModel
    ...
    private fun setTabs() {
        ...
        for (i in 0 until count) {
            ...
            if (i==0){
                ...
                itemView.textView.background.setTint(ContextCompat.getColor(binding.root.context, R.color.color_green))
            }
        ...
        binding.tablayout.addOnTabSelectedListener(object : TabLayout.OnTabSelectedListener {
            override fun onTabSelected(tab: TabLayout.Tab) {
                ...
                textview.background.setTint(ContextCompat.getColor(binding.root.context, R.color.color_green))
            }

            override fun onTabUnselected(tab: TabLayout.Tab) {
                val tabView = tab.customView
                val textview = tabView!!.findViewById<TextView>(R.id.text_view)
                textview.setTextColor(ContextCompat.getColor(binding.root.context, R.color.color_text))
                textview.background.setTint(ContextCompat.getColor(binding.root.context, R.color.color_light_back))
            }
